...
export default function Navbar() {
  ...
  return (
    <div className="lg:flex lg:w-full lg:items-center lg:justify-center bg-[#FF9000]">
      <motion.nav
      ...
      >
        ...
        <motion.div
          ...
          } w-full block flex-grow bg-[#FF9000] h-[100vh] z-50 fixed top-0 left-0 py-[50px] lg:hidden transition-all`}
          initial="closed"
          animate="open"
          variants={sideVariants}
          transition={{ duration: 5 }}
        >
          <div className="flex items-end justify-end mr-[50px] bg-[#FF9000]">
            <HamburgerMenu setIsOpen={setIsOpen} isOpen={isOpen} />
          </div>
          <div className="flex flex-col text-white mt-[50px] w-full bg-[#FF9000] ">
            <div className="pl-[50px] hover:bg-slate-300 py-4 cursor-pointer bg-[#FF9000]">
